...
from .views import SettingsListCreateAPIView, SettingsUpdateAPIView, VideosListAPIView, NotificationsListAPIView, CapturedImagesListAPIView, LogsListAPIView
